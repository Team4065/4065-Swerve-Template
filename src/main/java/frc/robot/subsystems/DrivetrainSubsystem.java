...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  public static final double MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND = MAX_VELOCITY_METERS_PER_SECOND /
          Math.hypot(DriveConstants.TRACKWIDTH_METERS / 2.0, DriveConstants.WHEELBASE_METERS / 2.0);
  ...
  private final PigeonIMU m_pigeon = new PigeonIMU(DriveConstants.PIGEON_ID);
